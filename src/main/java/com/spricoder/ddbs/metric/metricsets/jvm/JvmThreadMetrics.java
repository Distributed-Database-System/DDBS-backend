...
public class JvmThreadMetrics implements IMetricSet {
  ...
  public void bindTo(MetricService metricService) {
    ...
    metricService.createAutoGauge(
        "jvm_threads_peak_threads", threadBean, ThreadMXBean::getPeakThreadCount);

    metricService.createAutoGauge(
        "jvm_threads_daemon_threads", threadBean, ThreadMXBean::getDaemonThreadCount);

    metricService.createAutoGauge(
        "jvm_threads_live_threads", threadBean, ThreadMXBean::getThreadCount);
