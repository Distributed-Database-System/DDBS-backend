...
public class MockBlogServiceImpl implements BlogService {
    @Override
    public List<UserVO> getUserList(String uid, String name) {
        List<UserVO> list = new ArrayList<>();
        list.add(new UserVO("0","user0","male","email0","phone0","dept0","grade0","zh","Beijing","role0","tag42",15));
        list.add(new UserVO("1","user1","female","email1","phone1","dept1","grade1","en","Hong kong","role1","tag29",99));
        list.add(new UserVO("2","user2","male","email2","phone2","dept2","grade2","zh","Beijing","role2","tag42",17));
        return list;
    }

    @Override
    public List<ArticleVO> getArticleList(String aid, String title) {
    ...
    @Override
    public List<ReadingVO> getReadingList(String uid) {
    ...
    public ArticleDetailVO getArticleDetail(String aid, String uid) {
        return new ArticleDetailVO(
                aid,"1506000000002",
                "title1","technology","abstract of article 1","tags37",
                "author1417","zh","text_a0.txt",
                Arrays.asList("image_a7_0.jpg","2"),
                "",
                12,123,1234,12345
        );
    }
